-- EraUI quest map pane.
-- The quest pane the map opens on its right, in the manner of the 1.x quest
-- log: the list on the dark floor with plus and minus headers, yellow titles
-- in the 1.x difficulty colors and the old check for a tracked quest; a
-- quest's details on the old parchment in the parchment ink.
local _, EraUI = ...
...
local function Build()
    ...
    ns.ThemeTexture(floorTex, "marbleBg")
