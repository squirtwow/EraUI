-- EraUI status report.
-- One window with everything a bug report needs to begin with, read fresh
-- each time it opens and kept nowhere.
local ADDON, EraUI = ...
...
local function Build()
    local frame = CreateFrame("Frame", "EraUIClassicStatus", UIParent, "BackdropTemplate")
    frame:SetBackdrop({
